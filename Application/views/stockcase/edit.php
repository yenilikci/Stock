                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-cash-register mr-1"></i>"<?=$params['data']['ad']?>" Kasasını Düzenle</h3>
                        </div>

                        <form role="form" action="<?=SITE_URL;?>/stockcase/update/<?=$params['data']['id']?>" method="post">
                            <div class="card-body">
